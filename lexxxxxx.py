...
async def start(update: Update, context: CallbackContext) -> None:
    ...
    user_data_file = r"C:\Users\hp\agzam\.vscode\telegram\user_data.txt"
    user_exists = False
...
async def handle_contact(update: Update, context: CallbackContext) -> None:
    ...
    phone_data = r"C:\Users\hp\agzam\.vscode\telegram\phone_data.txt"
...
async def handle_location(update: Update, context: CallbackContext) -> None:
    ...
    location_data = r"C:\Users\hp\agzam\.vscode\telegram\location_data.txt"
    lines = []
...
async def search(update: Update, context: CallbackContext) -> None:
    ...
    search_queries_file = r"C:\Users\hp\agzam\.vscode\telegram\search_queries.txt"
    user_exists = False
